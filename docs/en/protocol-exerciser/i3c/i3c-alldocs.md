...
## Quick Start
1. Activate the [selecting bus](#bus-selection) by clicking the left box.
![Bus Select](../../images/i3c/topo-mode-init.png)
2. Set up the [PX-Pod parameters](#px-pair-settings) including pull-up resistance, Vdd, threshold and mode.
![Px_Pair_Ctrl](../../images/i3c/px-pair-ctrl.png)
3. Set up the [{++Address Table++}](#address-table), [{++Timing Settings++}](#timing-settings) (Those are not available in Target Mode.)
4. Set up the Decode settings for LA waveform.
5. *(Optional)* Add [Internal nodes](#internal-node).
6. *(Optional)* Enable the [DC power supply](../index.md#power-supply).
7. Press Run to activate and send the topology settings to exerciser.
...
![Px_Pair_Ctrl_Mode](../../images/i3c/px-pair-ctrl-mode.png)
Modes Seletion:
...
## Controller Mode
![Ctrl_Topo](../../images/i3c/topo-mode-controller.png)
...
![Light Err](../../images/i3c/Red.png) : Error Occured. Check the Status.
![Light Wait](../../images/i3c/Blue.png) : Wait for processing
![Light Skip](../../images/i3c/Gray.png) : Skip this process
![Light Pass](../../images/i3c/Green.png) : Process succeed

When the process succeed:
![Timing OK Run](../../images/i3c/run-ok.png)
...
![Wait Run](../../images/i3c/run-target.png)
...
When the process succeed:
![Timing OK Run](../../images/i3c/run-target-ok.png)
...
### I3C Node
![Internal Node 1](../../images/i3c/internal-node-settings-1.png)
![Internal Node 2](../../images/i3c/internal-node-settings-2.png)
...
4. I3C Node Information:
    ...
    4. Additional Settings: 
        1. GETCAPS:
        ![CAPS Ver1.0](../../images/i3c/getcaps-ver1-0.png)
        ...
        *Defining Byte Format only support 1 kind of defining byte.*
        ...
        CRHDLY:
        ![MXDS Defining](../../images/i3c/getmxds-def-crhdly.png)

        4. MWL & MRL:
        *IBI Size only enabled when BCR IBI related bit set to Support*
        ![MWL MRL Simple](../../images/i3c/MWLMRL.png)
...
### Quick Send
1. IBI:
![Quick Send - IBI](../../images/i3c/wizard-quick-ibi.png)
...
2. Hot Join:
![Quick Send - Hot Join](../../images/i3c/wizard-quick-hotjoin.png)
...
3. <a id="private-rw"></a>Private RW:
    ![Quick Send - Private RW](../../images/i3c/wizard-quick-private.png)
    ...
    ![Private Read SubAddr](../../images/i3c/private-rd-subaddr-edit.png)

    2. <a id="private-wr-subaddr"></a>Private Write with SubAddress
    ![Private Write SubAddr](../../images/i3c/private-wr-subaddr-edit.png)

4. Broadcast CCC:
    1. <a id="broadcast-ccc-enec"></a>Broadcast CCC - ENEC
    ![Broadcast CCC - ENEC](../../images/i3c/broadcast-ccc-enec-edit.png)
    ...
    ![Broadcast CCC - DISEC](../../images/i3c/broadcast-ccc-disec-edit.png)
    ...
    ![Broadcast CCC - ENTAS0](../../images/i3c/broadcast-ccc-entas0-edit.png)
    ...
    ![Broadcast CCC - ENTAS1](../../images/i3c/broadcast-ccc-entas1-edit.png)
    ...
    ![Broadcast CCC - ENTAS2](../../images/i3c/broadcast-ccc-entas2-edit.png)
    ...
    ![Broadcast CCC - ENTAS3](../../images/i3c/broadcast-ccc-entas3-edit.png)
    ...
    ![Broadcast CCC - RSTDAA](../../images/i3c/broadcast-ccc-rstdaa-edit.png)
    ...
    ![Broadcast CCC - ENTDAA](../../images/i3c/broadcast-ccc-entdaa-edit.png)
    ...
    ![Broadcast CCC - DEFTGTS](../../images/i3c/broadcast-ccc-deftgts-edit.png)
    ...
    ![Broadcast CCC - SETMWL](../../images/i3c/broadcast-ccc-setmwl-edit.png)
    ...
    ![Broadcast CCC - SETMRL](../../images/i3c/broadcast-ccc-setmrl-edit.png)
    ...
    ![Broadcast CCC - ENTTM](../../images/i3c/broadcast-ccc-enttm-edit.png)
    ...
    ![Broadcast CCC - SETBUSCON](../../images/i3c/broadcast-ccc-setbuscon-edit.png)
    ...
    ![Broadcast CCC - ENDXFER](../../images/i3c/broadcast-ccc-endxfer-edit.png)
    ...
    ![Broadcast CCC - ENTHDR0](../../images/i3c/broadcast-ccc-enthdr0-edit.png)
    ...
    The ENTHDR0 Broadcast CCC tells all targets that support HDR-DDR to:
        ...
        * Use double-data-rate transfers for higher throughput
        ...
        In this command, user can decide to turn on the "HDR Repeat".[^2]

    16. <a id="broadcast-ccc-enthdr1"></a>Broadcast CCC - ENTHDR1
    ![Broadcast CCC - ENTHDR1](../../images/i3c/broadcast-ccc-enthdr1-edit.png)
    ...
    ![Broadcast CCC - ENTHDR2](../../images/i3c/broadcast-ccc-enthdr2-edit.png)
    ...
    ![Broadcast CCC - ENTHDR3](../../images/i3c/broadcast-ccc-enthdr3-edit.png)
    ...
    ![Broadcast CCC - ENTHDR4](../../images/i3c/broadcast-ccc-enthdr4-edit.png)
    ...
    ![Broadcast CCC - ENTHDR5](../../images/i3c/broadcast-ccc-enthdr5-edit.png)
    ...
    ![Broadcast CCC - ENTHDR6](../../images/i3c/broadcast-ccc-enthdr6-edit.png)
    ...
    ![Broadcast CCC - ENTHDR7](../../images/i3c/broadcast-ccc-enthdr7-edit.png)
    ...
    ![Broadcast CCC - SETXTIME](../../images/i3c/broadcast-ccc-setxtime-edit.png)
    ...
    ![Broadcast CCC - SETAASA](../../images/i3c/broadcast-ccc-setaasa-edit.png)
    ...
    ![Broadcast CCC - RSTACT](../../images/i3c/broadcast-ccc-rstact-edit.png)
    ...
    ![Broadcast CCC - DEFGRPA](../../images/i3c/broadcast-ccc-defgrpa-edit.png)
    ...
    ![Broadcast CCC - RSTGRPA](../../images/i3c/broadcast-ccc-rstgrpa-edit.png)
    ...
    ![Broadcast CCC - MLANE](../../images/i3c/broadcast-ccc-mlane-edit.png)
    ...
    ![Broadcast CCC - Customized](../../images/i3c/broadcast-ccc-custom-edit.png)
    User can send out customized packet for specific purpose.

5. Direct CCC:
    1. <a id="direct-ccc-enec"></a>Direct CCC - ENEC
    ![Direct CCC - ENEC](../../images/i3c/direct-ccc-enec-edit.png)
    ...
    ![Direct CCC - DISEC](../../images/i3c/direct-ccc-disec-edit.png)
    ...
    ![Direct CCC - ENTAS0](../../images/i3c/direct-ccc-entas0-edit.png)
    ...
    ![Direct CCC - ENTAS1](../../images/i3c/direct-ccc-entas1-edit.png)
    ...
    ![Direct CCC - ENTAS2](../../images/i3c/direct-ccc-entas2-edit.png)
    ...
    ![Direct CCC - ENTAS3](../../images/i3c/direct-ccc-entas3-edit.png)
    ...
    ![Direct CCC - SETDASA](../../images/i3c/direct-ccc-setdasa-edit.png)
    ...
    ![Direct CCC - SETNEWDA](../../images/i3c/direct-ccc-setnewda-edit.png)
    ...
    ![Direct CCC - SETMWL](../../images/i3c/direct-ccc-setmwl-edit.png)
    ...
    ![Direct CCC - SETMRL](../../images/i3c/direct-ccc-setmrl-edit.png)
    ...
    ![Direct CCC - GETMWL](../../images/i3c/direct-ccc-getmwl-edit.png)
    ...
    ![Direct CCC - GETMRL](../../images/i3c/direct-ccc-getmrl-edit.png)
    ...
    ![Direct CCC - GETPID](../../images/i3c/direct-ccc-getpid-edit.png)
    ...
    ![Direct CCC - GETBCR](../../images/i3c/direct-ccc-getbcr-edit.png)
    ...
    ![Direct CCC - GETDCR](../../images/i3c/direct-ccc-getdcr-edit.png)
    ...
    ![Direct CCC - GETSTATUS](../../images/i3c/direct-ccc-getstatus-edit.png)
    ...
    ![Direct CCC - GETACCCR](../../images/i3c/direct-ccc-getacccr-edit.png)
    ...
    ![Direct CCC - ENDXFER](../../images/i3c/direct-ccc-endxfer-edit.png)
    ...
    ![Direct CCC - SETBRGTGT](../../images/i3c/direct-ccc-setbrgtgt-edit.png)
    ...
    ![Direct CCC - GETMXDS](../../images/i3c/direct-ccc-getmxds-edit.png)
    ...
    ![Direct CCC - GETCAPS](../../images/i3c/direct-ccc-getcaps-edit.png)
    ...
    ![Direct CCC - SETROUTE](../../images/i3c/direct-ccc-setroute-edit.png)
    ...
    ![Direct CCC - D2DXFER](../../images/i3c/direct-ccc-d2dxfer-edit.png)
    ...
    ![Direct CCC - SETXTIME](../../images/i3c/direct-ccc-setxtime-edit.png)
    ...
    ![Direct CCC - GETXTIME](../../images/i3c/direct-ccc-getxtime-edit.png)
    ...
    ![Direct CCC - RSTACT](../../images/i3c/direct-ccc-rstact-edit.png)
    ...
    ![Direct CCC - SETGRPA](../../images/i3c/direct-ccc-setgrpa-edit.png)
    ...
    ![Direct CCC - RSTGRPA](../../images/i3c/direct-ccc-rstgrpa-edit.png)
    ...
    ![Direct CCC - MLANE](../../images/i3c/direct-ccc-mlane-edit.png)
    ...
    ![Direct CCC - Customized](../../images/i3c/direct-ccc-reserved-edit.png)
    User can send out customized packet for specific purpose.

6. <a id="legacy-i2c-rw"></a>Legacy I2C RW
    ![Legacy I2C RW](../../images/i3c/i2c-legacy-rw.png)

    1. <a id="legacy-i2c-rd-subaddr"></a>Legacy I2C Read with SubAddr
    ![Legacy I2C Read with SubAddr](../../images/i3c/i2c-legacy-rd-subaddr-edit.png)

    2. <a id="legacy-i2c-wr-subaddr"></a>Legacy I2C Write with SubAddr
    ![Legacy I2C Write with SubAddr](../../images/i3c/i2c-legacy-wr-subaddr-edit.png)

    User can send out legacy I2C packet, for specific purpose.

[^2]: HDR Repeat
![HDR Repeat](../../images/i3c/broadcast-ccc-hdr-restart.png)
