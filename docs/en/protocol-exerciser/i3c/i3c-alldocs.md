...
![Px_Pair_Ctrl](../../images/protocol-exerciser/i3c/px-pair-ctrl.png)
...
![Px_Pair_Ctrl_Mode](../../images/protocol-exerciser/i3c/px-pair-ctrl-mode.png)
Modes Seletion:
...
![Px_Pair_Ctrl_Mode](../../images/protocol-exerciser/i3c/px-pair-ctrl-voltage.png)
1. Vdd: Set the working voltage.
2. LA Threshold: Set the LA threshold for decoding.
3. Hysteresis Range: Set the Hysteresis range.

### Resistance Settings
![Px_Pair_Ctrl_Mode](../../images/protocol-exerciser/i3c/px-pair-ctrl-resistance.png)
...
## Controller Mode
![Ctrl_Topo](../../images/protocol-exerciser/i3c/topo-mode-controller.png)
...
![Light Err](../../images/protocol-exerciser/i3c/red.png) : Error Occured. Check the Status.
![Light Wait](../../images/protocol-exerciser/i3c/blue.png) : Wait for processing
![Light Skip](../../images/protocol-exerciser/i3c/gray.png) : Skip this process
![Light Pass](../../images/protocol-exerciser/i3c/green.png) : Process succeed

When the process succeed:
![Timing OK Run](../../images/protocol-exerciser/i3c/run-ok.png)
...
![Wait Run](../../images/protocol-exerciser/i3c/run-target.png)
...
When the process succeed:
![Timing OK Run](../../images/protocol-exerciser/i3c/run-target-ok.png)
...
### I3C Node
![Internal Node 1](../../images/protocol-exerciser/i3c/internal-node-settings-1.png)
![Internal Node 2](../../images/protocol-exerciser/i3c/internal-node-settings-2.png)
...
3. Register Settings:
    ...
    2. Sub-Address Type:
        ...
        ![Without Sub-Address](../../images/protocol-exerciser/i3c/no-sub.png)
    ...
    3. Sub-Address Data Format: This setting only avaliable while the `Sub-Address Type` is set to `8-bit Sub-Address`
        ...
        ![Repeat Sub-Address](../../images/protocol-exerciser/i3c/sub-repeat.png)
        2. Increment Sub-Address
        ![Increment Sub-Address](../../images/protocol-exerciser/i3c/sub-inc.png)
        3. Increment Loop Sub-Address
        ![Increment Loop Sub-Address](../../images/protocol-exerciser/i3c/sub-inc-loop.png)
        4. Ignore Sub-Address
        ![Ignore Sub-Address](../../images/protocol-exerciser/i3c/sub-ignore.png)
...
4. I3C Node Information:
    ...
    4. Additional Settings: 
        1. GETCAPS:
        ![CAPS Ver1.0](../../images/protocol-exerciser/i3c/getcaps-ver1-0.png)
        This only enabled when selecting Version 1.0

        Format 1:
        ![CAPS Simple](../../images/protocol-exerciser/i3c/getcaps-ver1-1.png)
        ...
        *Defining Byte Format only support 1 kind of defining byte.*
        ![CAPS Defining](../../images/protocol-exerciser/i3c/getcaps-ver1-1-def.png)
        This is the same as the GETCAPS Format 1

        TESTPAT: 
        ![CAPS TEST Defining](../../images/protocol-exerciser/i3c/getcaps-ver1-1-def-test.png)
        
        CRCAPS: 
        ![CAPS CRCAPS Defining](../../images/protocol-exerciser/i3c/getcaps-ver1-1-def-crcaps.png)
        
        VRCAPS: 
        ![CAPS VTCAPS Defining](../../images/protocol-exerciser/i3c/getcaps-ver1-1-def-vtcaps.png)
        
        DBGCAPS:
        ![CAPS DBGCAPS Defining](../../images/protocol-exerciser/i3c/getcaps-ver1-1-def-dbgcaps.png)

        2. GETSTATUS:
        GETSTATUS Format 1:
        ![STATUS Simple](../../images/protocol-exerciser/i3c/getstatus.png)

        GETSTATUS Format 2:
        *Defining Byte Format only support 1 kind of defining byte.*
        ![STATUS Defining](../../images/protocol-exerciser/i3c/getstatus-def.png)
        This is the same as the GETSTATUS Format 1

        NASTAT:
        ![STATUS NASTAT Defining](../../images/protocol-exerciser/i3c/getstatus-def-nastat.png)

        PRECR:
        ![STATUS PRECR Defining](../../images/protocol-exerciser/i3c/getstatus-def-precr.png)

        SCMSTAT:
        ![STATUS SCMSTAT Defining](../../images/protocol-exerciser/i3c/getstatus-def-scmstat.png)

        
        3. GETMXDS:
        Format 1 & 2:
        ![MXDS Simple](../../images/protocol-exerciser/i3c/getmxds.png)

        Select *Support* in Defining Byte slot will enable the Defining byte format(Format 3) 

        Format 3
        *Defining Byte Format only support 1 kind of defining byte.*
        ![MXDS Defining](../../images/protocol-exerciser/i3c/getmxds-def-wrrdturn.png)

        This is the same as the GETMXDS Format 1 or 2

        CRHDLY:
        ![MXDS Defining](../../images/protocol-exerciser/i3c/getmxds-def-crhdly.png)

        4. MWL & MRL:
        *IBI Size only enabled when BCR IBI related bit set to Support*
        ![MWL MRL Simple](../../images/protocol-exerciser/i3c/mwlmrl.png)
        

### Legacy I2C Node
![Internal Node I2C](../../images/protocol-exerciser/i3c/internal-node-i2c.png)
...
3. Register Settings:
    ...
    2. Sub-Address Type:
        1. Without Sub-Address: Do not use Sub-Address.
        ![I2C Without Sub-Address](../../images/protocol-exerciser/i3c/no-sub-i2c.png)

        2. 8-bit Sub-Address: Sub-Address type. We now only support 8-bit Sub-Address.
    3. Sub-Address Data Format: This setting only avaliable while the `Sub-Address Type` is set to `8-bit Sub-Address`
        1. Repeat Sub-Address
        ![I2C Repeat Sub-Address](../../images/protocol-exerciser/i3c/sub-repeat-i2c.png)

        2. Increment Sub-Address
        ![I2C Increment Sub-Address](../../images/protocol-exerciser/i3c/sub-inc-i2c.png)

        3. Increment Loop Sub-Address
        ![I2C Increment Loop Sub-Address](../../images/protocol-exerciser/i3c/sub-inc-loop-i2c.png)

        4. Ignore Sub-Address
        ![I2C Ignore Sub-Address](../../images/protocol-exerciser/i3c/sub-ignore-i2c.png)



### I3C Stress Test
![Internal Node Stress](../../images/protocol-exerciser/i3c/internal-node-stress.png)
