...
4. *(Optional)* **[Configure DC output](../px.md#power-supply)** - Power your device under test
...
8. **[Send commands](controller.md#send-packet)** - Use the I2C wizard to send READ/WRITE transactions