...
4. *(Optional)*Set up your [DC output](px.md#power-supply).
...
8. Send commands using [I2C wizard](#send-packet) in [Controller mode](#controller-mode) only.
...
2. Open the detail editing dialog.
    ...
    2. Detailly edit the packet.
        ![Detail edit the packet](/images/i2c/detail-edit-packet.png)
...
![Targer Mode Wizard](/images/i2c/target-mode-wizard.png)
