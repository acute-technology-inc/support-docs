...
2. *(Optional)*Set up your [DC output](px.md#power-supply).
3. [Decode and Timing Settings](#decode-timing) for UART signals analysis.
4. [Establish the Connection](#connect)
5. Send data using [UART wizard](#send-packet).

## Px Pair Settings
![Px Pair Settings](../img/uart/px pair setting.png)
...
## Functions
![Topology](../img/uart/topology.png)
...
### Decode & Timing
![UART decode](../img/uart/decode.png)
...
#### Packet Constructor
![Send packet from bus](../img/uart/send packet from bus.png)
...
##### Edit Packet
![Edit Packet](../img/uart/edit packet.png)

1. Adjust the packet order.
2. Open the detail editing dialog.
    ![Sequence packet](../img/uart/sequence packet.png)

    1. Add a UART packet
    2. Detailly edit the packet.
        ![Detail edit the packet](../img/uart/detail edit packet.png)
    ...
    5. Change the display format, We now suppor two formats:
        1. Packet Mode: Not only display the data, but also display the START bit and STOP bit.
            ![Packet Mode](../img/uart/packet mode.png)

        2. Data Mode: only display the data.
            ![Data Mode](../img/uart/data mode.png)
