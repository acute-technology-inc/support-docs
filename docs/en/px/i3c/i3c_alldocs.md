...
### Quick Send
1. IBI:
![Quick Send - IBI](../img//i3c/Wizard_Quick_IBI.png)
...
2. Hot Join:
![Quick Send - Hot Join](../img/i3c/Wizard_Quick_HotJoin.png)
...
3. <a id="private-rw"></a>Private RW:
    ![Quick Send - Private RW](../img/i3c/Wizard_Quick_Private.png)
    ...
    ![Private Read SubAddr](../img/i3c/Private_Rd_SubAddr_Edit.png)

    2. <a id="private-wr-subaddr"></a>Private Write with SubAddress
    ![Private Write SubAddr](../img/i3c/Private_Wr_SubAddr_Edit.png)

4. Broadcast CCC:
    1. <a id="broadcast-ccc-enec"></a>Broadcast CCC - ENEC
    ![Broadcast CCC - ENEC](../img/i3c/Broadcast_CCC_ENEC_Edit.png)
    ...
    ![Broadcast CCC - DISEC](../img/i3c/Broadcast_CCC_DISEC_Edit.png)
    ...
    ![Broadcast CCC - ENTAS0](../img/i3c/Broadcast_CCC_ENTAS0_Edit.png)
    ...
    ![Broadcast CCC - ENTAS1](../img/i3c/Broadcast_CCC_ENTAS1_Edit.png)
    ...
    ![Broadcast CCC - ENTAS2](../img/i3c/Broadcast_CCC_ENTAS2_Edit.png)
    ...
    ![Broadcast CCC - ENTAS3](../img/i3c/Broadcast_CCC_ENTAS3_Edit.png)
    ...
    ![Broadcast CCC - RSTDAA](../img/i3c/Broadcast_CCC_RSTDAA_Edit.png)
    ...
    ![Broadcast CCC - ENTDAA](../img/i3c/Broadcast_CCC_ENTDAA_Edit.png)
    ...
    ![Broadcast CCC - DEFTGTS](../img/i3c/Broadcast_CCC_DEFTGTS_Edit.png)
    ...
    ![Broadcast CCC - SETMWL](../img/i3c/Broadcast_CCC_SETMWL_Edit.png)
    ...
    ![Broadcast CCC - SETMRL](../img/i3c/Broadcast_CCC_SETMRL_Edit.png)
    ...
    ![Broadcast CCC - ENTTM](../img/i3c/Broadcast_CCC_ENTTM_Edit.png)
    ...
    ![Broadcast CCC - SETBUSCON](../img/i3c/Broadcast_CCC_SETBUSCON_Edit.png)
    ...
    ![Broadcast CCC - ENDXFER](../img/i3c/Broadcast_CCC_ENDXFER_Edit.png)
    ...
    ![Broadcast CCC - ENTHDR0](../img/i3c/Broadcast_CCC_ENTHDR0_Edit.png)
    ...
    ![Broadcast CCC - ENTHDR1](../img/i3c/Broadcast_CCC_ENTHDR1_Edit.png)
    ...
    ![Broadcast CCC - ENTHDR2](../img/i3c/Broadcast_CCC_ENTHDR2_Edit.png)
    ...
    ![Broadcast CCC - ENTHDR3](../img/i3c/Broadcast_CCC_ENTHDR3_Edit.png)
    ...
    ![Broadcast CCC - ENTHDR4](../img/i3c/Broadcast_CCC_ENTHDR4_Edit.png)
    ...
    ![Broadcast CCC - ENTHDR5](../img/i3c/Broadcast_CCC_ENTHDR5_Edit.png)
    ...
    ![Broadcast CCC - ENTHDR6](../img/i3c/Broadcast_CCC_ENTHDR6_Edit.png)
    ...
    ![Broadcast CCC - ENTHDR7](../img/i3c/Broadcast_CCC_ENTHDR7_Edit.png)
    ...
    ![Broadcast CCC - SETXTIME](../img/i3c/Broadcast_CCC_SETXTIME_Edit.png)
    ...
    ![Broadcast CCC - SETAASA](../img/i3c/Broadcast_CCC_SETAASA_Edit.png)
    ...
    ![Broadcast CCC - RSTACT](../img/i3c/Broadcast_CCC_RSTACT_Edit.png)
    ...
    ![Broadcast CCC - DEFGRPA](../img/i3c/Broadcast_CCC_DEFGRPA_Edit.png)
    ...
    ![Broadcast CCC - RSTGRPA](../img/i3c/Broadcast_CCC_RSTGRPA_Edit.png)
    ...
    ![Broadcast CCC - MLANE](../img/i3c/Broadcast_CCC_MLANE_Edit.png)
    ...
    ![Broadcast CCC - Customized](../img/i3c/Broadcast_CCC_Custom_Edit.png)
    User can send out customized packet for specific purpose.

5. Direct CCC:
    1. <a id="direct-ccc-enec"></a>Direct CCC - ENEC
    ![Direct CCC - ENEC](../img/i3c/Direct_CCC_ENEC_Edit.png)
    ...
    ![Direct CCC - DISEC](../img/i3c/Direct_CCC_DISEC_Edit.png)
    ...
    ![Direct CCC - ENTAS0](../img/i3c/Direct_CCC_ENTAS0_Edit.png)
    ...
    ![Direct CCC - ENTAS1](../img/i3c/Direct_CCC_ENTAS1_Edit.png)
    ...
    ![Direct CCC - ENTAS2](../img/i3c/Direct_CCC_ENTAS2_Edit.png)
    ...
    ![Direct CCC - ENTAS3](../img/i3c/Direct_CCC_ENTAS3_Edit.png)
    ...
    ![Direct CCC - SETDASA](../img/i3c/Direct_CCC_SETDASA_Edit.png)
    Direct CCC, SETDASA instructs a specific I3C target device on the bus, identified by its static I²C address, to adopt a new dynamic 7-bit address assigned by the controller.
    ...
    ![Direct CCC - SETNEWDA](../img/i3c/Direct_CCC_SETNEWDA_Edit.png)
    ...
    ![Direct CCC - SETMWL](../img/i3c/Direct_CCC_SETMWL_Edit.png)
    ...
    ![Direct CCC - SETMRL](../img/i3c/Direct_CCC_SETMRL_Edit.png)
    ...
    ![Direct CCC - GETMWL](../img/i3c/Direct_CCC_GETMWL_Edit.png)
    ...
    ![Direct CCC - GETMRL](../img/i3c/Direct_CCC_GETMRL_Edit.png)
    ...
    ![Direct CCC - GETPID](../img/i3c/Direct_CCC_GETPID_Edit.png)
    ...
    ![Direct CCC - GETBCR](../img/i3c/Direct_CCC_GETBCR_Edit.png)
    ...
    The Direct GETBCR CCC tells the target to:
        ...
        * Indicate whether the device supports key I³C features such as I³C target mode, I²C legacy compatibility, and in-band interrupt capability
    ...
    ![Direct CCC - GETDCR](../img/i3c/Direct_CCC_GETDCR_Edit.png)
    ...
    ![Direct CCC - GETSTATUS](../img/i3c/Direct_CCC_GETSTATUS_Edit.png)
    ...
    ![Direct CCC - GETACCCR](../img/i3c/Direct_CCC_GETACCCR_Edit.png)
    ...
    ![Direct CCC - ENDXFER](../img/i3c/Direct_CCC_ENDXFER_Edit.png)
    ...
    ![Direct CCC - SETBRGTGT](../img/i3c/Direct_CCC_SETBRGTGT_Edit.png)
    ...
    ![Direct CCC - GETMXDS](../img/i3c/Direct_CCC_GETMXDS_Edit.png)
    ...
    ![Direct CCC - GETCAPS](../img/i3c/Direct_CCC_GETCAPS_Edit.png)
    ...
    ![Direct CCC - SETROUTE](../img/i3c/Direct_CCC_SETROUTE_Edit.png)
    ...
    ![Direct CCC - D2DXFER](../img/i3c/Direct_CCC_D2DXFER_Edit.png)
    ...
    ![Direct CCC - SETXTIME](../img/i3c/Direct_CCC_SETXTIME_Edit.png)
    ...
    ![Direct CCC - GETXTIME](../img/i3c/Direct_CCC_GETXTIME_Edit.png)
    ...
    ![Direct CCC - RSTACT](../img/i3c/Direct_CCC_RSTACT_Edit.png)
    ...
    ![Direct CCC - SETGRPA](../img/i3c/Direct_CCC_SETGRPA_Edit.png)
    ...
    ![Direct CCC - RSTGRPA](../img/i3c/Direct_CCC_RSTGRPA_Edit.png)
    ...
    ![Direct CCC - MLANE](../img/i3c/Direct_CCC_MLANE_Edit.png)
    ...
    ![Direct CCC - Customized](../img/i3c/Direct_CCC_Reserved_Edit.png)
    User can send out customized packet for specific purpose.

6. <a id="legacy-i2c-rw"></a>Legacy I2C RW
    ![Legacy I2C RW](../img/i3c/I2C_Legacy_RW.png)

    1. <a id="legacy-i2c-rd-subaddr"></a>Legacy I2C Read with SubAddr
    ![Legacy I2C Read with SubAddr](../img/i3c/I2C_Legacy_Rd_SubAddr_Edit.png)

    2. <a id="legacy-i2c-wr-subaddr"></a>Legacy I2C Write with SubAddr
    ![Legacy I2C Write with SubAddr](../img/i3c/I2C_Legacy_Wr_SubAddr_Edit.png)

    User can send out legacy I2C packet, for specific purpose.

[^2]: HDR Repeat
![HDR Repeat](../img/i3c/Broadcast_CCC_HDR_Restart.png)
